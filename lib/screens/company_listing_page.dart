      ...
      return PopScope(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            key: StorageService.scaffoldRiKey1,
            // appBar: AppBar(
            //   title: const Text(''),
            //   actions: [
            //     Material(
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            StorageService.scaffoldRiKey1.currentState?.openDrawer();
                          },
                        ),
                        IconButton(
                          icon: const Icon(
                                            ...
                                            child: ListTile(
                                              ...
                                              trailing: Tooltip(
                                                ...
                                                margin: EdgeInsets.only(
                                                    left: MediaQuery.of(context).size.width / 3, right: generalPadding),
                                                child: CircleAvatar(
                                                  radius: 16,
                                                  backgroundColor:
                                                      company.isApplied ? Colors.green : Theme.of(context).primaryColor,
                                                  child: const Icon(
                                                    Icons.square,
                                                    color: Colors.white,
                                                    size: 12,
